  ...
  <div class="flex flex-col">
    ...
    <div class="w-screen bg-black h-fit px-12 md:px-24 xl:px-48 py-32">
      <p class="text-white text-2xl text-center mt-4 font-bold">
        {{
          $i18n.locale == "en"
            ? texts.descriptionEnglish
            : texts.descriptionPortuguese
        }}
      </p>
    </div>
    ...
    <div class="h-fit w-screen blob-scene">
      <div
        class="mt-20 py-12 p-12 xl:pt-96 flex flex-col text-center justify-center items-center"
      >
        <h1 class="text-5xl font-black mb-8 pt-[4.5rem]">
          {{
            $i18n.locale == "en"
        ...
        <div
          class="flex flex-col items-center md:flex-row justify-center w-full"
        >
          <figure
            class="w-64 flex flex-col rounded-xl bg-[#282828] mb-8 md:mr-8 md:mb-0"
          >
            ...
            <div class="px-6 pb-6 text-left mb-0">
              ...
              <code class="flex items-center">
                ...
                <div
                  class="p-2 absolute ml-44 rounded-md bg-[#323232] cursor-pointer hover:bg-primary tooltip"
                  @click="copyText('grao')"
                >
                  <img
          ...
          <figure class="w-64 flex flex-col rounded-xl bg-[#282828]">
            <div class="bg-[#1eff00] w-64 h-20 rounded-t-xl"></div>
            <div class="flex">
              <div class="p-2 rounded-full w-24 h-24 bg-[#282828] -mt-12 ml-4">
                <img
                  class="w-full h-full rounded-full"
                  src="https://cdn.discordapp.com/avatars/216344998176751616/5c2c6628045472e1f64626e112597d53.webp"
                  alt=""
                  width="384"
                  height="512"
                />
            ...
            <div class="px-6 pb-6 text-left mb-0">
              <h1 class="text-2xl font-bold">Colde</h1>
              <code class="flex items-center">
                colde9321
                <div
                  class="p-2 absolute ml-44 rounded-md bg-[#323232] cursor-pointer hover:bg-primary"
                  @click="copyText('marinayamamoto')"
                >
                  <img
                    src="@/assets/icons/copy.png"
                    width="16"
      ...
      <div
        class="h-screen w-screen p-12 lg:p-96 flex flex-col text-center justify-center items-center blob"
      >
        <h1
          class="text-7xl font-black mb-8 pt-[4.5rem] hover:text-primary hover:underline"
        >
          <a href="mailto:wonderacid@gmail.com">{{
            $i18n.locale == "en" ? "Or send us an email!" : "Ou envie um email!"
          }}</a>
        </h1>
      </div>
    </div>
